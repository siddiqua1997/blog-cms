 ...
 * Contact Page
 *
 * Premium dark theme contact form matching Toxic Tuning design.
        ...
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="opacity-0 animate-fade-in-up" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
              {status === 'success' ? (
                <div className="card-premium-light rounded-3xl p-8 md:p-12 text-center">
                  ...
                  <p className="text-grey-600 mb-8">
                    Thank you for reaching out. One of our specialists will get back
                ...
                <div className="card-premium-light rounded-3xl p-8 md:p-12">
                  ...
                  {/* Error Message */}
                  {status === 'error' && (
                    <div className="bg-red-primary/10 border border-red-primary/20 text-red-primary px-4 py-3 rounded-xl mb-6">
